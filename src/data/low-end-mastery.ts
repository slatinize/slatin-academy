export const modules = [
  ...
  },
  {
    ...
    topics: [
      "Kick & Bass - The Ideal Low End",
      "Dynamic Phase Rotation - Best Kept Secret",
      "Low-End Coherence",
  ...
  },
  {
    ...
    topics: [
      "Using Spectre instead of RBass or BassXXL",
      "Working Towards Loudness",
...
export const faqItems = [
  ...
  },
  {
    ...
    answer: "You'll need a computer or laptop, plus a reliable pair of headphones or studio monitors (ideally in an acoustic treated space). Any setup you're comfortable working with will do the job.",
  },
  {
