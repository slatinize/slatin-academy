    ...
    cards: [
      {
        ...
        title: "Weekly Video Reviews",
        description: "Send your tracks and get detailed video feedback with specific, actionable fixes every week.",
      ...
      },
      {
        ...
        description: "70-minute live sessions with a multi-platinum engineer. Ask anything, get real-time answers.",
      ...
      },
      {
        ...
        title: "Major-Label Techniques",
        description: "Learn the exact methods used on records for Sony, Warner and Def Jam, and apply them to your own work.",
      ...
      },
      {
        ...
        description: "Pricing, clients and label negotiations. Everything you need to build a sustainable music career.",
        valueTag: "Real business, not just hobby money",
      },
    ],
    extrasTitle: "Also Included",
    extras: [
      { highlight: "2h of live group calls every week", text: "real-time guidance, Q&A and mix reviews in every session." },
      { highlight: "150+ hours of lessons available", text: "a full library of mixing, mastering and music business content you can access anytime." },
      { highlight: "Private community of serious producers", text: "collaborate, get feedback and build relationships that last beyond the program." },
      { highlight: "Curated tools and resources", text: "the exact samples, presets and books I use, plus FUSION (Valhalla VintageVerb pack) free." },
      { highlight: "Battle-tested email templates", text: "proven outreach templates that actually get replies from labels, managers and promoters." },
      { highlight: "Industry insider knowledge", text: "how the business really works, so you stop wasting years figuring it out alone." },
    ],
  },
